...
export const UserRequestAppointmentDetailsScreen =
  ({}: UserRequestAppointmentDetailsScreenProps) => {
    ...
    if (!currentAppointment) {
      return (
        <View>
          <Text>Appuntamento inesistente</Text>
        </View>
      );
    }
      ...
      <View style={styles.section}>
        ...
        <View style={styles.sectionContent}>
          <ProfessionalAvatarDetails
            professional={currentAppointment.professionalOffer!.professional}
          />
    ...
    const renderVisitDetails = () => {
      const address = new Address(currentAppointment.officeLocation);
                ...
                <TouchableOpacity onPress={onAddToCalendarPressed}>
                  <View style={styles.addToCalendarButton}>
                    <View style={styles.buttonContent}>
                      <CalendarAddIcon
                        color={colorTokens.colorIconInformation}
                      />
            ...
            <View>
              <View style={styles.costRow}>
                ...
                <Text style={styles.costValue}>
                  {formatPrice((currentAppointment?.price ?? 0) * 0.2)}
                </Text>
              </View>
              <View style={styles.costRow}>
                <View>
                ...
                <View style={styles.totalCostContainer}>
                  ...
                  <Text style={styles.costTotal}>
                    da {formatPrice(currentAppointment?.price ?? 0)}
                  </Text>
                </View>
              </View>
            </View>
