...
const firstStepFieldKeys = ["firstName", "lastName", "birthDate"] as const;
const secondStepFieldKeys = ["email", "password", "confirmPassword"] as const;
...
export const useUserRegisterScreen = () => {
  ...
  const onNextStepButtonPressed = async () => {
    ...
    if (stepValid) setStepperCounter(2);
  };
