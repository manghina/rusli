...
const professionsOptions: {
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Trapianto d'organo in età pediatrica",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Prevenzione e gestione dell'obesità",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Gestione del peso e dell'obesità",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Obesità e disturbi alimentari",
      ...
      {
        label: "Riproduzione e disturbi della fertilità",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Motilità gastrointestinale",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Malattie cardiovascolari in età avanzata",
        value: "1a9fcbeb-90cf-4e93-b7ac-e7dcaf189ade",
      },
      {
        label: "Osteoporosi e fratture da fragilità",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Endocrinologia ginecologica e infertilità",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label:
          "Certificazioni per attività sportive agonistiche e non agonistiche",
        value: "37396421-9c89-406d-8610-3e6934c8f577",
      },
      {
        label: "Valutazioni di disabilità e handicap",
        value: "cb6a06eb-56db-49fc-91a7-8cb7d4b33cc8",
      },
      {
        label: "Certificazioni per patenti di guida e idoneità alla guida",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Responsabilità medica e malpractice",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Disturbi dell'attenzione e iperattività (ADHD)",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Infezioni ossee e articolari in età pediatrica",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Conservazione della fertilità",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Radioterapia a intensità modulata (IMRT)",
  ...
  },
  {
    ...
    options: [
      ...
      {
        label: "Andrologia e infertilità maschile",
